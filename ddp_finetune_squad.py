...
def main():
    ...
    train_loader = DataLoader(train_dataset, batch_size=160, sampler=train_sampler, collate_fn=custom_collate_fn)

    val_loader = DataLoader(tokenized_dataset["validation"], batch_size=160, collate_fn=custom_collate_fn)
