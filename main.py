...
def main():
    ...
    base_train_loader = data_loader_obj.get_dataloader(split='train', batch_size=512)
    train_dataset = base_train_loader.dataset
    train_loader = TorchDataLoader(train_dataset, batch_size=512)

    val_loader = data_loader_obj.get_dataloader(split='validation', batch_size=512)
