...
def main():
    ...
    # Loss function with hidden_size=1024 to match teacher; move to device
    ...
    # Create trainer, validator (pass teacher_model here), and evaluator
    ...
    val_loader = data_loader_obj.get_dataloader(split='validation', batch_size=32)
    ...
    for epoch in range(num_epochs):
        ...
        for i, batch in pbar:
            ...
            # Perform a mini evaluation every eval_interval iterations on the main process
        ...
        # Full validation at the end of the epoch
